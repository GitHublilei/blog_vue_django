...
class OrderInfo(models.Model):
    ...
    nonce_str = models.CharField(max_length=50, null=True, unique=True, blank=True, verbose_name=u"随机")
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name="第三方支付 ")
