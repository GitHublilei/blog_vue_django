...
class GoodsCategory(models.Model):
    ...
    Category_type = models.CharField(choices=CATEGORY_TYPE, verbose_name="父类目级", max_length=10)
...
class GoodsCategroyBrand(models.Model):
    ...
    品牌名
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="商品类目", default="", on_delete=models.CASCADE)
...
class GoodsImage(models.Model):
    ...
    image_url = models.CharField(max_length=300, null=True, verbose_name="图片url")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
